...
rem pytest -v -m "sanity and regression" --html=./Reports/report_chrome.html testCases/ --browser chrome
rem pytest -v -m "sanity and regression" --html=./Reports/report_egde.html testCases/ --browser edge
